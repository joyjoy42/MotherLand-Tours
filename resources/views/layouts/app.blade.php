...
<body>
    ...
    <nav class="navbar">
        <div class="container" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
            <a href="/" class="logo">MOTHERLAND <span>TOURS</span></a>
    ...
    <footer class="footer">
        <div class="container">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 48px;">
                <div>
                    <div class="footer-logo">MOTHERLAND <span>TOURS</span></div>
                ...
                <div>
                    ...
                    <p style="font-size: 0.9rem; color: #94a3b8; margin-bottom: 12px; display: flex; align-items: center; gap: 10px;">
                        <i class="fas fa-envelope" style="color: var(--primary);"></i> <a href="mailto:motherlandtours9@gmail.com" style="color: inherit; text-decoration: none;">motherlandtours9@gmail.com</a>
                    </p>
                    <p style="font-size: 0.9rem; color: #94a3b8; display: flex; align-items: center; gap: 10px;">
                        <i class="fas fa-phone" style="color: var(--primary);"></i> <a href="tel:+2290148803613" style="color: inherit; text-decoration: none;">+229 0148803613</a>
                    </p>
                </div>
                <div>
