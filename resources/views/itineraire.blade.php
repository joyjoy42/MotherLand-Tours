...
<section style="position: relative; background: url('/images/packs-hero.jpg') center/cover no-repeat; padding: 120px 0; color: white; text-align: center;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        ...
        <h1 style="font-size: 3.5rem; color: white; font-weight: 800; margin-bottom: 24px;">L'<span style="color: var(--color-mother-terracotta);">Itinéraire</span> Signature</h1>
...
<section class="section-padding bg-grain" style="background: white;">
    <div class="container">
        ...
        <div style="max-width: 1000px; margin: 0 auto; position: relative;">
                ...
                <div class="premium-card day-box" data-day="{{ $num }}" style="margin-bottom: 40px; border-radius: var(--radius-lg); display: {{ $num <= 7 ? 'block' : 'none' }};">
                    <div style="display: flex; gap: 40px; align-items: flex-start;">
                        <div style="flex-shrink: 0; text-align: center;">
                            <div style="background: var(--color-mother-terracotta); color: white; width: 64px; height: 64px; border-radius: 20px; display: flex; flex-direction: column; align-items: center; justify-content: center; box-shadow: 0 8px 16px -4px rgba(230, 144, 77, 0.3);">
                        ...
                        <div style="flex: 1;">
                            <h3 style="font-size: 1.6rem; margin-bottom: 16px; color: var(--color-mother-navy);">{{ $day['title'] }}</h3>
                            <p style="font-size: 1.05rem; color: #475569; margin-bottom: 24px; line-height: 1.7;">{{ $day['desc'] }}</p>
                            
                            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                                <span style="background: var(--color-primary-light); color: var(--color-mother-terracotta); padding: 8px 16px; border-radius: 100px; font-size: 0.8rem; font-weight: 700;">VISITE GUIDÉE</span>
            ...
            <!-- Final CTA -->
            <div class="premium-card" style="text-align: center; background: var(--color-mother-navy); color: white; margin-top: 80px; position: relative; overflow: hidden;">
                <div style="position: absolute; top: -20px; right: -20px; width: 100px; height: 100px; background: var(--color-mother-terracotta); border-radius: 50%; opacity: 0.1;"></div>
