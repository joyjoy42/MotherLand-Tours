...
<section style="position: relative; background: url('/images/packs-hero.jpg') center/cover no-repeat; padding: 120px 0; color: white; text-align: center;">
    ...
    <div class="container" style="position: relative; z-index: 2;">
        ...
        <h1 style="font-size: 3.5rem; color: white; font-weight: 800; margin-bottom: 24px;">Votre <span style="color: var(--color-mother-terracotta);">Voyage</span> Unique</h1>
...
<section class="section-padding bg-grain" style="background: white;">
    <div class="container">
        <div style="max-width: 900px; margin: 0 auto;">
            <!-- Premium Info Box -->
            <div style="background: #fffbf2; border: 1px solid #fff3e0; border-radius: var(--radius-lg); padding: 40px; margin-bottom: 64px; display: flex; gap: 32px; align-items: center;">
                <div style="width: 64px; height: 64px; background: white; border-radius: 20px; display: flex; align-items: center; justify-content: center; color: var(--color-mother-terracotta); font-size: 1.8rem; flex-shrink: 0; box-shadow: var(--shadow-sm);">
                    <i class="fas fa-wand-magic-sparkles"></i>
                </div>
                <div>
                    <h4 style="color: var(--color-mother-navy); margin-bottom: 12px; font-size: 1.2rem;">Ce formulaire est pour vous si :</h4>
                    <ul style="list-style: none; font-size: 0.95rem; color: #a34e0d; display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 32px; margin-top: 64px;">
                <div class="premium-card" style="text-align: center; border: 1px solid var(--color-mother-teal); background: #e6fdfa;">
                    <i class="fab fa-whatsapp" style="font-size: 2rem; color: var(--color-mother-teal); margin-bottom: 20px;"></i>
                    <h4 style="margin-bottom: 12px;">Échange rapide</h4>
                    <p style="font-size: 0.9rem; color: var(--color-mother-teal); margin-bottom: 24px;">Pour une réponse instantanée à vos questions.</p>
                    <a href="https://wa.me/22948803613" target="_blank" class="btn" style="background: var(--color-mother-teal); color: white; width: 100%;">Lancer WhatsApp</a>
                </div>
                <div class="premium-card" style="text-align: center; border: 1px solid var(--color-primary-light); background: var(--color-primary-light);">
                    <i class="fas fa-envelope-open-text" style="font-size: 2rem; color: var(--color-mother-navy); margin-bottom: 20px;"></i>
                    <h4 style="margin-bottom: 12px;">Dossier complet</h4>
                    <p style="font-size: 0.9rem; color: var(--color-mother-navy); margin-bottom: 24px;">Envoyez-nous vos documents ou parcours types.</p>
                    <a href="mailto:motherlandtours9@gmail.com" class="btn" style="background: var(--color-mother-navy); color: white; width: 100%;">Écrire un Email</a>
                </div>
            </div>
        </div>
    </div>
